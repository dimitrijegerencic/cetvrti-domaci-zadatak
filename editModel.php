            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 mt-5 ">
                <div class=" bg-light rounded p-4 p-sm-5 my-4 mx-3 mt-5 mb-5 shadow-lg" id="panel">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h4 class="text-center">Change the selected model</h4>
                    </div>
                    <hr/>
                    <div class="row">
                        <div class="col-12">
                          <form action="updateModel.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?=$model['id']?>">  
                            <input type="text" required class="form-control mt-3 mb-3" id="floatingInput" name="model_name" value="<?=$model['model_name']?>">
