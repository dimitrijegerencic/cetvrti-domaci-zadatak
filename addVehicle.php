            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-6 ">
                <div class=" bg-light rounded p-4 p-sm-5 my-4 mx-3 mt-5 mb-5 shadow-lg" id="panel">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h4 class="text-center">Add a new vehicle</h4>
                    </div>             
                    <form action="saveVehicle.php" method="POST" enctype="multipart/form-data">
                      <div class="row mb-3 mt-2">
                        <div class="col-6">
                          <label for="registration_number">Registration number</label>
                          <input type="text" required class="form-control" name="registration_number" placeholder="Insert registration number">
                        </div>
                        <div class="col-6">
                        <label for="production_year">Production year</label>
                        <input type="text" required class="form-control" name="production_year" placeholder="Insert production year" maxlength="4">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-6">
                          ...
                          <select name="company_id" id="company_id" class="form-control mb-3" onchange="displayModels()">
                                    <option value="" selected disabled >Choose a company</option>
                                        <?php 
                                            ...
                                            $queryData[] = $row;
                                            $idTemp = $row['id'];
                                            $currCompanyName = $row['company_name'];
                                            
                                            echo "<option value=\"$idTemp\" >$currCompanyName</option>";
                                            }
                          ...
                          <select name="class_id" id="class_id" class="form-control">
                                <option value="" selected disabled >Choose a class</option>
                                    ...
                                    <?php 
                                        ...
                                        $queryData[] = $row;
                                        $idTemp = $row['id'];
                                        $currClassName = $row['class_name'];
                                        
                                        echo "<option value=\"$idTemp\">$currClassName</option>";
                                        }
