            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-7 ">
                <div class=" bg-light rounded p-4 p-sm-5 my-4 mx-3 mt-5 mb-5 shadow-lg" id="panel">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h4 class="text-center">Add a new client</h4>
                    </div>
                    <hr/>
                    ...
                    <div class="row">
                      <div class="col-8">
                          <input type="text" required class="form-control" id="floatingInput" name="passport_number" placeholder="Passport number" required>
                      </div>
                      <div class="col-4">
                          ...
                          <option value="" selected disabled >Choose a state</option>
                            <?php 
                                ...
                                while($row = mysqli_fetch_assoc($res)){
                                  ...
                                  $queryData[] = $row;
                                  $idTempState = $row['id'];
                                  $currStateName = $row['state_name'];
                                  
                                  echo "<option value=\"$idTempState\" >$currStateName</option>";
                                }
